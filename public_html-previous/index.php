...
<html lang="en">
  ...
  <body>
    ...
    ?>
      ...
      <!--==========================-->
      <section
        class="banner banner-one new-challange"
      ...
      >
        <div class="row">
          <div>
            ...
            >
              <div id="testme" class="container" style="display: none">
                <div class="banner-content-wrap">
                  <div class="row align-items-center">
                    <div class="col-lg-12">
                      <div class="banner-content wow pixFadeDown extra-task" data-wow-delay="0.2s">
                          <div id="text">

                            <h1 style="text-align:center; !important;" class="banner-title"
                            
                             
                            >
                            <p class="words">O'Learys Södra</p>
                        ...
                        >
                          <div
                            ...
                            "
                          >
                            <div class="" style="font-size: 22px; margin-bottom: 1rem;">
